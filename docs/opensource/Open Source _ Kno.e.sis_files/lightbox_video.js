...
Lightvideo = {
  ...
  checkYouTubeVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        ...
        var href = "https://web.archive.org/web/20150710191349/http://www.youtube.com/v/"+Lightbox.videoId;
        var variables = 'fs=1';
        if (Lightbox.flvFlashvars.length) {
  ...
  checkGoogleVideo: function(href) {
    var patterns = [
      'https://web.archive.org/web/20150710191349/http://video.google.[a-z]{2,4}/googleplayer.swf\\?docId=(-?\\d*)',
      'https://web.archive.org/web/20150710191349/http://video.google.[a-z]{2,4}/videoplay\\?docid=([^&]*)&',
      'https://web.archive.org/web/20150710191349/http://video.google.[a-z]{2,4}/videoplay\\?docid=(.*)'
      ];
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        var href = "https://web.archive.org/web/20150710191349/http://video.google.com/googleplayer.swf?docId="+Lightbox.videoId+"&hl=en";
  ...
  checkMetacafeVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150710191349/http://www.metacafe.com/fplayer/"+Lightbox.videoId+"/.swf", "flvvideo", "#ffffff");
        return true;
      }
    }
    return false;
  ...
  checkIFilmSpikeVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150710191349/http://www.spike.com/efp", "flvvideo", "#000", "flvbaseclip="+Lightbox.videoId+"&amp;");
        return true;
      }
    }
    return false;
  ...
  checkMySpaceVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150710191349/http://lads.myspace.com/videos/vplayer.swf", "flvvideo", "#ffffff", "m="+Lightbox.videoId);
        return true;
      }
    }
    return false;
  ...
  checkLiveVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150710191349/http://www.livevideo.com/flvplayer/embed/"+Lightbox.videoId, "flvvideo", "#ffffff");
        return true;
      }
    }
    return false;
...
/*
     FILE ARCHIVED ON 19:13:49 Jul 10, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:53:19 Aug 23, 2022.
...
/*
playback timings (ms):
  captures_list: 111.51
  exclusion.robots: 0.117
  exclusion.robots.policy: 0.106
  RedisCDXSource: 1.414
  esindex: 0.01
  LoadShardBlock: 87.086 (3)
  PetaboxLoader3.datanode: 704.816 (5)
  CDXLines.iter: 16.416 (3)
  load_resource: 1606.149 (2)
  PetaboxLoader3.resolve: 965.845 (2)
*/