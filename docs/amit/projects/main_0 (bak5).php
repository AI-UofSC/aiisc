<iframe src="//www.slideshare.net/slideshow/embed_code/key/1AT3BI67yTWlmu" width="100%" height="375" frameborder="0" marginwidth="0" marginheight="0" scrolling="no" style="border:1px solid #CCC; border-width:1px; margin-bottom:5px; max-width: 100%;" allowfullscreen> 
</iframe> 

<div style="margin-bottom:5px"> <strong> <a href="//www.slideshare.net/apsheth/whats-up-at-knoesis-a-brief-review-of-current-projects" title="What&#x27;s up at Kno.e.sis? " target="_blank">What&#x27;s up at Kno.e.sis? </a> </strong> from <strong><a href="//www.slideshare.net/apsheth" target="_blank">Dr. Amit Sheth</a></strong> 
</div>
...
<p style="text-align:justify">	
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				<td width="200" valign="top">N2-5521</td>
				<td width="249" valign="top"><a href="http://knoesis.org/faculty/tkprasad">Prasad</a> (PI)</td>
				<td width="175" valign="top">12/01/2016 - 08/31/2021</td>
			</tr>

			<tr>	
				<td width="200" valign="top">DoD SBIR/STTR</td>
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (Co-PI)</td>
				<td width="175" valign="top">$527,295</td>
			</tr>

			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong><a href="http://wiki.knoesis.org/index.php/MIDAS">Medical Information Decision Assistance and Support - Phase II</a>:</strong>
				<br>
				In response to the DOD Small Business Innovation and Research (SBIR) Phase II Topic N151-069, Medical Informatics Decision Assistance and Support (MIDAS), Milcord and Kno.e.sis will research and develop a design for a medical information decision assistance and support tool that leverages a musculoskeletal injury knowledge base and algorithms to predict the risk of obtaining injuries during training regimens and recommend appropriate mitigations to reduce the likelihood of occurrence.
				</td>
			</tr>
		</tbody>
	</table><br><br>
	...
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				...
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
				<td width="175" valign="top">04/01/2016 - 03/31/2019</td>
			</tr>

			<tr>	
				<td width="200" valign="top">WSRI</td>
				<td width="249" valign="top"></td></td>
				<td width="175" valign="top">$419,997</td>
			</tr>

		
			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong>IARPA Mercury:</strong>
				<br>
				</td>
			</tr>
...
<p style="text-align:justify">	
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				<td width="200" valign="top">NSF IIS 1622628</td>
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
				<td width="175" valign="top">03/01/2016 - 02/28/2017</td>
			</tr>

			<tr>	
				<td width="200" valign="top">NSF</td>
				<td width="249" valign="top"></td>
				<td width="175" valign="top">$20,000</td>
			</tr>

			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong>III: Travel Fellowships for Students from U.S. Universities to Attend ISWC 2016:</strong>
				<br>
				This National Science Foundation award funds Student Travel Fellowships for US students attending the 15th International Semantic Web Conference (ISWC 2016). The conference, which will be held in Kobe, Japan from October 17 to 21, is the premier major international forum for state-of-the-art research on all aspects of the Semantic Web and data on the Web&mdash;the next generation World Wide Web. This allows students to meet key members the Semantic Web research community, it gives them the opportunity to disseminate their work, and it provides a venue for them to interact with future national and international scientific collaborators. 
				</td>
			</tr>
		</tbody>
	</table><br><br>
	...
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				<td width="200" valign="top"></td>
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
				<td width="175" valign="top">01/01/2016 - 12/31/2016</td>
			</tr>

			<tr>	
				<td width="200" valign="top">Universal Freelancer</td>
				<td width="249" valign="top"></td>
				<td width="175" valign="top">$30,000</td>
			</tr>

			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong>Employee and Job Search Semantic Engine: Phase I:</strong>
				<br>
...
<h2>2015</h2>
	<p style="text-align:justify">	
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">CNS 1513721</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">10/01/2015 - 03/31/2017</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Mackay (Co-Investigator)</td>
					<td width="175" valign="top">$200,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/Market_Driven_Innovations_and_Scaling_up_of_Twitris">PFI: AIR-TT: Market-driven Innovations and Scaling up of Twitris - A System for Collective Social Intelligence</a>:</strong>
					<br>
	...
	<p style="text-align:justify">	
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">NSF IIS 1513721</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">10/01/2015 - 08/31/2018</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top"><a href="http://knoesis.org/faculty/shalin/">Shalin</a>, <a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (Co-PIs)</td>
					<td width="175" valign="top">$925,104 + $16,000 (REU)</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/Context-Aware_Harassment_Detection_on_Social_Media">TWC SBE: Medium: Context-Aware Harassment Detection on Social Media</a>:</strong>
					<br>
...
<p style="text-align:justify">	
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				<td width="200" valign="top">IIS 1522075</td>
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
				<td width="175" valign="top">08/01/2016 - 07/31/2018</td>
			</tr>

			<tr>	
				<td width="200" valign="top">NSF</td>
				<td width="249" valign="top"><a href="http://knoesis.org/faculty/tkprasad">Prasad</a> (Co-PI), <a href="http://www.childrensdayton.org/cms/dayton_childrens_doctors/73947ab691cabcde/index.html">Forbis</a> (Co-PI)</td>
				<td width="175" valign="top">$991,804</td>
			</tr>

			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong><a href="http://wiki.knoesis.org/index.php/Asthma">SCH: INT: kHealth: A Semantic Approach to Proactive, Personalized Asthma Management Using Multimodal Sensing</a>:</strong>
				<br>
				This research will develop algorithms and techniques to empower patients and doctors by providing personalized, contextually-relevant, and actionable information synthesized from a comprehensive understanding of health-relevant data. This will be accomplished through (i) semantic representation, extraction, abstraction, and integration of multimodal and multi-sensory observations, including patient feedback (semantic perception), (ii) developing a personalized early warning model through statistical and declarative knowledge and interleaved abductive-deductive reasoning for a more accurate  representation of real-world data dependencies/effects (hybrid knowledge representation), and (iii) an enhanced system which can reliably collect and analyze data to generate recommendations locally on resource-constrained devices (efficient execution). Using a pilot study, we will evaluate the effectiveness of decision support to doctors and alerts to patients. Specifically, the proposed research will uncover correlations among extracted sensor features, their relationship to the control and severity of asthma, and will personalize management of asthma.
				</td>
			</tr>
		</tbody>
	</table><br><br>
	...
	<p style="text-align:justify">	
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">SC-1507-01</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (PI)</td>
					<td width="175" valign="top">07/06/2015 - 03/30/2016</td>
				</tr>

				<tr>	
					<td width="200" valign="top">DoD SBIR/STTR</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (Co-PI)</td>
					<td width="175" valign="top">$25,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/MIDAS">Medical Information Decision Assistance and Support (MIDAS) - Phase I</a>:</strong>
					<br>
	...
	<!-- No longer hidden; Dr. Sheth instructed to display on web. -->
 	<p style="text-align:justify">	
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">1 R01 MH105384-01A1</td>
					<td width="249" valign="top">Pathak*, <a href="http://knoesis.org/amit/">Sheth</a> (PIs)</td>
					<td width="175" valign="top">07/01/2015 - 06/30/2019</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIH</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (Co-PI)</td>
					<td width="175" valign="top">Total: $1,934,525<br>WSU: $505,603</td>
					<!-- $2,195,362: increased amount; haven't received guidance about displaying -->
				</tr>

				
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/Modeling_Social_Behavior_for_Healthcare_Utilization_in_Depression">Modeling Social Behavior for Healthcare Utilization in Depression</a>:</strong>
					<br>
 	...
 	<p style="text-align:justify">	
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">EAR 1520870</td>
					<td width="249" valign="top">Parthasarthy*, <a href="http://knoesis.org/amit/">Sheth</a> (PIs)</td>
					<td width="175" valign="top">07/01/2015 - 07/31/2019</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Liu*, Kubatko*, <a href="http://knoesis.org/faculty/shalin/">Shalin</a>, <a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> <br>(Co-PIs)</td>
					<td width="175" valign="top">Total: $1,975,000<br>WSU: $787,500</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/Hazard_Sees">Hazards SEES: Social and Physical Sensing Enabled Decision Support for Disaster Management and Response</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (PI)</td>
					<td width="175" valign="top">07/01/2015 - 09/30/2015</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Pratt &amp; Whitney</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (Co-PI)</td>
					<td width="175" valign="top">$89,736</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Semantic Web-based Data Exchange and Interoperability for OEM-Supplier Collaboration:</strong>
					<br>
	...
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				<td width="200" valign="top"></td>
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
				<td width="175" valign="top">01/01/2015 - 12/31/2016</td>
			</tr>

			<tr>	
				<td width="200" valign="top">Ohio Office of Criminal Justice Services</td>
				<td width="249" valign="top"><a href="http://knoesis.org/doran">Doran</a>, <a href="https://people.wright.edu/jack.dustin">Dustin</a> (Co-PIs)</td>
				<td width="175" valign="top">$140,000</td>
			</tr>

			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong><a href="http://wiki.knoesis.org/index.php/Project_Safe_Neighborhood">Westwood Partnership to Prevent Juvenile Repeat Violent Offenders</a>:</strong>
				<br>
	...
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			<tr>
				<td width="200" valign="top"></td>
				<td width="249" valign="top"><b>Recipient</b>: <a href="http://knoesis.org/researchers/sujan/">Perera</a></td> 
				<td width="175" valign="top">2015 - 2016</td>
			</tr>

			<tr>	
				<td width="200" valign="top">Health Data Consortium</td>
				<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td></td>
				<td width="175" valign="top">$21,000</td>
			</tr>

			<tr>
				<td width="100%" colspan="3" valign="top" style="text-align:justify">
				<strong>2015-2016 George Thomas Fellowship</strong>
				<br>
				An unrestricted gift of $21,000 to Wright State University from the Health Data Consortium to cover Sujan Perera’s stipend for the 2015-2016 academic year.
				</td>
			</tr>
		</tbody>
	</table><br><br>
...
<h2>2014</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">R01 1R01DA039454-01</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, <a href="http://people.wright.edu/raminta.daniulaityte">Daniulaityte</a>, Boyer*, Martins**(PIs)</td>
					<td width="175" valign="top">08/15/2014 - 08/14/2017</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIH/NIDA</td>
					<td width="249" valign="top"><a href="http://people.wright.edu/robert.carlson">Carlson</a>, <a href="http://people.wright.edu/ramzi.nahhas">Nahhas</a>, <a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (Co-PIs)</td>
					<td width="175" valign="top">Total: $1,689,019</td>
				</tr>
    
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/EDrugTrends">Trending: Social Media Analysis to Monitor Cannabis and Synthetic Cannabinoid Use (eDrugTrends)</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">R56DA038366-01</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, Boyer*, <a href="http://people.wright.edu/robert.carlson">Carlson</a> (PIs)</td>
					<td width="175" valign="top">07/01/2014 - 09/14/2016</td> 
					<!-- End date of 9/14/15 on Kno.e.sis wiki, but was instructed to extend by 1 year. -->
				</tr>

				<tr>	
					<td width="200" valign="top">NIH/NIDA</td>
					<td width="249" valign="top"><a href="http://people.wright.edu/raminta.daniulaityte">Daniulaityte</a>, <a href="http://people.wright.edu/ramzi.nahhas">Nahhas</a> (Co-PI)</td>
					<td width="175" valign="top">$299,741</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/NIDA_National_Early_Warning_System_Network_(iN3)">NIDA National Early Warning System Network (iN3): An Innovative Approach</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">06/02/2014 - 06/01/2015</td>
				</tr>

				<tr>	
					<td width="200" valign="top">ezDI</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$125,000</td> 
					<!-- Added additional $25K on 12/14/15 at request of Dr. Sheth -->
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Cardiology Semantic Analysis System:</strong>
					<br>
...
<h2>2013</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">IIP-13403041</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">07/01/2013 - 12/31/2013</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$50,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Towards Commercialization of Twitris&mdash;A System of Collective Intelligence:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">SUB 1122472-001</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">07/01/2013 - 07/30/2014 </td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL/RX</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a>, <a href="http://cecs.wright.edu/~rsrin/Research/Research.htm">Srinivasan</a> (Co-PIs)</td>
					<td width="175" valign="top">$190,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://www.knoesis.org/research/KDDM">Materials Database Knowledge Discovery and Data Mining</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/faculty/swang/">Wang</a> (PI)</td>
					<td width="175" valign="top">06/15/2013 - 06/14/2014</td>
				</tr>

				<tr>	
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, <a href="http://cecs.wright.edu/~keke.chen/">Chen</a>, Zhang (Co-PIs)</td>
					<td width="175" valign="top">$492,472</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Software and Hardware Infrastructure for Energy-efficient, Large-scale Complex Language Modeling:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">FA 8750-13-1-0244</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">06/01/2013 - 12/31/2015</td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a>, <a href="http://cecs.wright.edu/~rsrin/Research/Research.htm">Srinivasan</a> (Co-PIs)</td>
					<td width="175" valign="top">$309,028</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>SemMat: Federated Semantic Services Platform for Open Materials Science and Engineering:</strong>
					<br>
...
<h2>2011</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">IIS-1111182, 1237631, 1349151</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, Parthasarthy* (PI)</td>
					<td width="175" valign="top">09/01/2011 - 08/30/2015</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top"><a href="http://knoesis.org/resources/faculty/shalin/">Shalin</a>, <a href="http://psych-scholar.wright.edu/flach">Flach</a></td>
					<td width="175" valign="top">$518,408</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>SoCS: Collaborative Research: Social Media Enhanced Organizational Sensemaking in Emergency Response</a>:</strong>
					<br>
		...
		*Ohio State University.<br><br><br>
		
		
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">IIS-1143717</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>(PI)</td>
					<td width="175" valign="top">09/2011 - 08/2013</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top"><a href="http://dase.cs.wright.edu/">Hitzler</a> (Co-PI)</td>
					<td width="175" valign="top">$141,828</td>
					<!-- Amount includes $16,000 supplemental award -->
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://knoesis.org/research/semweb/projects/ESQuILO">EAGER: Expressive Scalable Querying Over Linked Open Data</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">R21 DA030571-01A1</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, <a href="http://people.wright.edu/raminta.daniulaityte">Daniulaityte</a> (PIs)</td>
					<td width="175" valign="top">07/01/2011 - 06/30/2013</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIH/NIDA</td>
					<td width="249" valign="top"><a href="http://people.wright.edu/robert.carlson">Carlson</a>, <a href="http://people.wright.edu/russel.falck">Falck</a> (Co-PIs)</td>
					<td width="175" valign="top">$401,500</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/PREDOSE">A Study of Social Web Data on Buprenorphine Abuse Using Semantic Web Technology</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">DRC C00557P 0011596 02</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>(PI)</td>
					<td width="175" valign="top">06/2011 - 12/2012</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Riverside Research</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (Co-PI)</td>
					<td width="175" valign="top">$81,539</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Trusted Semantic Sensor Web to Support Decision Making Over Massive Amounts of Sensor and Social Data:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">04/2011</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Janya</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$25,150</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Enhancing Information Extraction with linked Open Data:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">Dept. of Community Health</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">01/2011</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Wright State University</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$30,000</td>
				</tr>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/PREDOSE">A Study of Social Web Data on Oxycontin Abuse Using Semantic Web Technology</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">Microsoft Corporation</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">2011</td>
				</tr>
...
<h2>2010</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">FA8650-08-D-6801</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">11/2010 - 10/2013</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Ball Aerospace</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$306,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>T040: LVC Sensors Integration for Data Fusion in Operations and Training:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">FA8650-09-D-6939</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">05/2010 - 12/2010</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Woolpert</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$42,500</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Information Operations/Cyber Exploitation Research (ICER) Program, City Beat:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">04/2010 - 03/2011</td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL, WPAFB</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$300,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Ontology and Semantic-Aided Human Cognition Knowledge Discovery:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">06/01/2008 - 05/31/2009</td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL &amp; OGC/DAGSI</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$63,281</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Architectures for Secure Semantic Sensor Networks for Multi-Layered Sensing:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">06/2009</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Wright State University</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a>, <a href="http://knoesis.wright.edu/faculty/swang/">Wang</a>, <a href="http://cecs.wright.edu/~mrizki/">Rizki</a>, <a href="http://knoesis.wright.edu/faculty/swang/">Wang</a>, <br> <a href="http://cecs.wright.edu/~pmateti/PM/index.html">Mateti</a>, <a href="http://www.wright.edu/~yan.liu/">Liu</a>, <a href="https://people.wright.edu/john.gallagher">Gallagher</a>, <a href="http://cecs.wright.edu/~keke.chen/">Chen</a>, <a href="http://cecs.wright.edu/~ypei/">Pei</a>, <a href="http://www.cs.wright.edu/~mraymer/">Raymer</a>, (Co-PIs)</td>
					<td width="175" valign="top">$48,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Cloud Computing Collaboratory:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">02/2009 - 07/2011</td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$176,890</td> 
					<!-- Amount and dates are a combination of two items: TSSN-Phase 1 and TSSN -->
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Semantic Sensor Network:</strong>
					<br>
...
<h2>2008</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">IIS-0842129, 0937647</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">08/2008 - 12/2011</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top"><a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (Co-PI)</td>
					<td width="175" valign="top">$146,952</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Spatio-Temporal-Thematic Queries of Semantic Web Data&mdash;A Study of Expressivity and Efficiency:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">FA8650-05-2-6518</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, <a href="http://knoesis.wright.edu/tkprasad/">Prasad</a> (PIs)</td>
					<td width="175" valign="top">07/2008 - 03/2009</td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$100,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Human Performance Ontology (HPO):</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					<td width="200" valign="top">Undisclosed Sponsor</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$120,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Trusted_Semantic_Sensor_Web&action=edit&redlink=1">Trusted Semantic Sensor Web</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">1R01 HL087795-01A1</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">05/2008 - 06/2012</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NHLBI</td>
					<td width="249" valign="top">Tarleton*, Musen**, Noy**, <br>Doshi* (Co-PIs)</td>
					<td width="175" valign="top">$1,509,540</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Semantics and Services Enabled Problem Solving Environment for Trypanosoma cruzi:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">02/2008</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Microsoft Research</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$60,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Chatter, Intent, Good Karma, and Contextual Advertisements in Social Networks:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">11/2007</td>
				</tr>

				<tr>	
					<td width="200" valign="top">IBM</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$23,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>UIMA-based Infrastructure for Summarizing Casual, Unstructured Text:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">04/2007 - 08/2007</td>
				</tr>

				<tr>	
					<td width="200" valign="top">AFRL</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$32,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Sensor Data Management:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">06/01/2006 - 06/30/2018</td>
				</tr>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Advanced Data Management Resource (Ohio's Research Challenge 2005-2007 Biennium):</strong>
					<br>
...
<h2>2005</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">IIS-0545243</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">10/2005 - 12/31/2007</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Arpinar, Kochut, Miller (Co-PIs)</td>
					<td width="175" valign="top">$100,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/semgrid/
					">SemGrid (Semantic Discovery on Adaptive Services Grid)</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">04/2005 - 09/2006</td>
				</tr>

				<tr>	
					<td width="200" valign="top">ARDA</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$325,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/library/resources/index.php?page=3">SemDis: Financial Irregularity Detection</a>:</strong>
					<br>
...
<h2>2003</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">NSF IIS-0738251, 0714441</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">10/01/2003 - 09/30/2007</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Arpinar, Kochut, Miller, Joshi, <br>
                    Finn, Yesha (Co-PIs)</td>
					<td width="175" valign="top">$1,250,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/SemDis/">SemDis: Discovering Complex Relationships in Semantic Web</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">07/01/2003 - 06/302008</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIH</td>
					<td width="249" valign="top">Kochut, Miller (Co-PIs)</td>
					<td width="175" valign="top">$709,401</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/glycomics/">Bioinformatics for Glycan Expression</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a>, Bhandarkar, Li, Waterson</td>
					<td width="175" valign="top"></td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>System-Level Technique for Energy-Aware Computing:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">07/01/2002 - 06/30/2005</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Arpinar, Kochut (Co-PIs)</td>
					<td width="175" valign="top">$212,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/sai/">SAI (Association Identification and Knowledge Discovery for National Security Applications)</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">04/01/2002 - 03/31/2003</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$26,250</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Database and Information Systems Research for Semantic Web and Enterprises:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">01/01/2000 - 09/30/2000</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NRL, ITT</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$200,000</td>
				</tr>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Extending METEOR with Workflow Reuse, Adaptation, and Collaboration:</strong>
					<br>
...
<h2>1998</h2>	
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">N00173-98-2-L005</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">07/01/1998 - 12/31/1999</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NRL</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$330,542</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Workflow Management for Advanced DOD Applications:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">06/1996 - 05/1999</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIST-ATP</td>
					<td width="249" valign="top">Kochut, Miller, Shah (Co-PIs)</td>
					<td width="175" valign="top">$172,129</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/past/">Collaborative Tele-Consulting for Healthcare (CaTCH)</a>:</strong>
					<br>
...
<h2>1995</h2>	
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">95-FI38400-000</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">04/15/1995 - 08/30/1997</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Community Management Staff (CIA)</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$197,030</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/past/">InfoHarness: A Scalable System for Searching Heterogeneous Information</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">70ANB5H1011</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top">03/1995 - 08/1999</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIST-ATP</td>
					<td width="249" valign="top">Miller, Kochut (Co-PIs)</td>
					<td width="175" valign="top">$1,674,729</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/past/">METEOR: Healthcare Information Infrastructure Program&mdash;Enterprise Workflow Automation</a>:</strong>
					<br>
	...
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/meteor-s/">METEOR-S: Semantic Web Services and Processes</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/sens/">SeNS (Semantically Enabled Networking and Services)</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://lsdis.cs.uga.edu/projects/middleware/">Semantic Middleware</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">CRW165049</td>
					<td width="249" valign="top"><a href="http://knoesis.org/amit/">Sheth</a> (PI)</td>
					<td width="175" valign="top"></td>
				</tr>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Model Generation and Model Extension for Information and Knowledge Management:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=SCIE_-_Semantic_Computing_and_Internet_Economics&action=edit&redlink=1">Semantic Computing and Internet Economics</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>HP Live Information Management:</strong>
					<br>
