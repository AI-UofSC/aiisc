		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					...
					<td width="249" valign="top"><strong>Sheth</strong> (PI)</td>
					<td width="175" valign="top">09/01/2015 - 08/31/2018</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Shalin, Prasad (Co-PIs)</td>
					<td width="175" valign="top">$925,104</td>
				</tr>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					...
					<td width="249" valign="top">Parthasarthy, <strong>Sheth</strong> (PIs)</td>
					<td width="175" valign="top">08/15/2015 - 07/31/2019</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Liu, Kubatko, Shalin, Prasad (Co-PIs)</td>
					<td width="175" valign="top">$1,975,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/Hazard_Sees">Hazard SEES: Social and Physical Sensing Enabled Decision Support for Disaster Management and Response</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					...
					<td width="249" valign="top">Prasad (PI)</td>
					<td width="175" valign="top">07/01/2015 - 03/30/2016</td>
				</tr>

				<tr>	
					<td width="200" valign="top">DoD SBIR/STTR</td>
					<td width="249" valign="top"><strong>Sheth</strong> (Co-PI)</td>
					<td width="175" valign="top">$25,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>Medical Information Decision Assistance and Support (MIDAS):</strong>
					<br>
	...
	<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
		<tbody>
			...
			<tr>	
				...
				<td width="249" valign="top">Doran, Dustin (Co-PIs)</td>
...
<h2>2014</h2>
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					...
					<td width="249" valign="top"><strong>Sheth</strong>, Daniulaityte (PIs)</td>
					<td width="175" valign="top">08/15/2014 - 08/14/2017</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIH/NIDA</td>
					<td width="249" valign="top">Carlson, Nahhas, Prasad (Co-PIs)</td>
					<td width="175" valign="top">$1,689,019</td>
				</tr>
    
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php/EDrugTrends">Trending Social Media Analysis to Monitor Cannabis and Synthetic Cannabinoid Use</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top">R56 R56DA038366-01</td>
					<td width="249" valign="top"><strong>Sheth</strong>, Boyer, Carlson (PIs)</td>
					<td width="175" valign="top">07/01/2014 - 06/30/2015</td>
				</tr>

				<tr>	
					<td width="200" valign="top">NIH/NIDA</td>
					<td width="249" valign="top">Daniulaityte (Co-PI)</td>
					<td width="175" valign="top">$258,806</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>NIDA National Early Warning System Network (iN3): An Innovative Approach:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Cardiology_Semantic_Analysis_System:_Phase_I&action=edit&redlink=1">Cardiology Semantic Analysis System</a>:</strong>
					<br>
	...
	<p style="text-align:justify">
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					...
					<td width="249" valign="top">Prasad, Srinivasan (Co-PIs)</td>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					<td width="200" valign="top"></td>
					<td width="249" valign="top">Wang (PI)</td>
					<td width="175" valign="top">06/15/2013 - 06/14/2014</td>
				</tr>

				<tr>	
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><strong>Sheth</strong>, Chen, Zhang (Co-PIs)</td>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					...
					<td width="249" valign="top">Prasad, Srinivasan (Co-PIs)</td>
					<td width="175" valign="top">$298,028</td>
				</tr>
				...
				<tr>
					...
					<br>
					This major goal of the project is enable flexible sharing and exploitation of materials data through three tasks. The first is related to creating semantic infrastructure to annotate materials data utilizing materials domain models and knowledge bases. The second relates to semantic search for a varieties of data, including resources with services based access. The third relates to development of a novel open semantic data exchange scheme for materials science (termed Linked Open Materials Data).						
					</td>
				</tr>
			</tbody>
		</table><br><br>
	...
	<p style="text-align:justify">
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					<td width="200" valign="top">NSF</td>
					<td width="249" valign="top">Hitzler (Co-PI)</td>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					<td width="200" valign="top">NIH/NIDA</td>
					<td width="249" valign="top">Carlson, Falck (Co-PIs)</td>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					...
					<td width="249" valign="top">Prasad (Co-PI)</td>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Enhancing_Information_Extraction_with_linked_Open_Data&action=edit&redlink=1">Enhancing Information Extraction with linked Open Data</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=SemGrail_2011&action=edit&redlink=1">SemGrail 2011</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
	...
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=SIDFOT_-_T040_Subtask_sow:LVC_Sensors_Integration_for_Data_Fusion_in_Operations_and_Training&action=edit&redlink=1">T040: LVC Sensors Integration for Data Fusion in Operations and Training</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					...
					<td width="249" valign="top"><strong>Sheth</strong> (PI)</td>
					<td width="175" valign="top">07/2010 - 12/2010</td>
				</tr>

				<tr>	
					<td width="200" valign="top">Woolpert</td>
					<td width="249" valign="top"></td>
					<td width="175" valign="top">$148,402</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=ICER:_Information_Operations/Cyber_Exploitation_Research_Program,_City_Beat&action=edit&redlink=1">Information Operations/Cyber Exploitation Research (ICER) Program, City Beat</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Ontology_and_Semantic-Aided_Human_Cognition_Knowledge_Discovery&action=edit&redlink=1">Ontology and Semantic-Aided Human Cognition Knowledge Discovery</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
	...
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Arch_for_Secure_Semantic_Sens_Network_DAGSI&action=edit&redlink=1">Architectures for Secure Semantic Sensor Networks for Multi-Layered Sensing</a>:</strong>
					<br>
					</td>
				</tr>
			</tbody>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					<td width="200" valign="top">Wright State University</td>
					<td width="249" valign="top">Prasad, Wang, Rizki, Wang, <br> Mateti, Liu, Gallagher, Chen, Pei, Raymer, (Co-PIs)</td>
					<td width="175" valign="top">$48,000</td>
				</tr>

				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Cloud_Computing_Collaboratory&action=edit&redlink=1">Cloud Computing Collaboratory</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Trusted_Semantic_Sensor_Network&action=edit&redlink=1">Trusted Semantic Sensor Network</a>:</strong>
					<br>
	...
	<p style="text-align:justify">
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=STT:_Spatio-Temporal-Thematic_Queries_of_Semantic_Web_Data_-_A_Study_of_Expressivity_and_Efficiency&action=edit&redlink=1">Spatio-Temporal-Thematic Queries of Semantic Web Data&mdash;A Study of Expressivity and Efficiency</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				<tr>
					...
					<td width="249" valign="top"><strong>Sheth</strong>, Prasad (PIs)</td>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Human_Performance_Ontology_(HPO)&action=edit&redlink=1">Human Performance Ontology (HPO)</a>:</strong>
					<br>
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong><a href="http://wiki.knoesis.org/index.php?title=Tcruzi_-_Semantics_and_Services_Enabled_Problem_Solving_Environment_for_Trypanosoma_cruzi&action=edit&redlink=1">Semantics and Services Enabled Problem Solving Environment for Trypanosoma cruzi</a>:</strong>
					<br>
	...
	<p style="text-align:justify">
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>
					<td width="100%" colspan="3" valign="top" style="text-align:justify">
					<strong>An Ontological Approach to Financial Analysis & Monitoring:</strong>
					<br>
					</td>
				</tr>
			</tbody>
	...
	<p style="text-align:justify">
		...
		<table border="0" cellspacing="0" cellpadding="1" bordercolor="#D8D8D8">	
			<tbody>
				...
				<tr>	
					<td width="200" valign="top"></td>
					<td width="249" valign="top"><strong>Sheth</strong>, Bhandarkar, Li, Waterson</td>
					<td width="175" valign="top"></td>
				</tr>
