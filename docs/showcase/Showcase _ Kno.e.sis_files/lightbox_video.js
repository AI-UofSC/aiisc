...
Lightvideo = {
  ...
  checkYouTubeVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        ...
        var href = "https://web.archive.org/web/20150316091041/http://www.youtube.com/v/"+Lightbox.videoId;
        var variables = 'fs=1';
        if (Lightbox.flvFlashvars.length) {
  ...
  checkGoogleVideo: function(href) {
    var patterns = [
      'https://web.archive.org/web/20150316091041/http://video.google.[a-z]{2,4}/googleplayer.swf\\?docId=(-?\\d*)',
      'https://web.archive.org/web/20150316091041/http://video.google.[a-z]{2,4}/videoplay\\?docid=([^&]*)&',
      'https://web.archive.org/web/20150316091041/http://video.google.[a-z]{2,4}/videoplay\\?docid=(.*)'
      ];
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        var href = "https://web.archive.org/web/20150316091041/http://video.google.com/googleplayer.swf?docId="+Lightbox.videoId+"&hl=en";
  ...
  checkMetacafeVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150316091041/http://www.metacafe.com/fplayer/"+Lightbox.videoId+"/.swf", "flvvideo", "#ffffff");
        return true;
      }
    }
    return false;
  ...
  checkIFilmSpikeVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150316091041/http://www.spike.com/efp", "flvvideo", "#000", "flvbaseclip="+Lightbox.videoId+"&amp;");
        return true;
      }
    }
    return false;
  ...
  checkMySpaceVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150316091041/http://lads.myspace.com/videos/vplayer.swf", "flvvideo", "#ffffff", "m="+Lightbox.videoId);
        return true;
      }
    }
    return false;
  ...
  checkLiveVideo: function(href) {
    ...
    for (var i = 0; i < patterns.length; i++) {
      ...
      if (results !== null) {
        Lightbox.videoId = results[1];
        Lightvideo.createEmbed("https://web.archive.org/web/20150316091041/http://www.livevideo.com/flvplayer/embed/"+Lightbox.videoId, "flvvideo", "#ffffff");
        return true;
      }
    }
    return false;
...
/*
     FILE ARCHIVED ON 09:10:41 Mar 16, 2015 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 18:26:16 Aug 23, 2022.
...
/*
playback timings (ms):
  captures_list: 60.832
  exclusion.robots: 0.134
  exclusion.robots.policy: 0.124
  RedisCDXSource: 5.62
  esindex: 0.011
  LoadShardBlock: 32.888 (3)
  PetaboxLoader3.datanode: 86.124 (5)
  CDXLines.iter: 19.122 (3)
  load_resource: 130.65 (2)
  PetaboxLoader3.resolve: 53.882 (2)
*/